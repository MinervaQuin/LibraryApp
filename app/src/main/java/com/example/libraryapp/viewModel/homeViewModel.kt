...
class homeViewModel @Inject constructor(
    ...
    var collectionArray = MutableStateFlow<List<CollectionSamples>>(
        listOf(
            ...
            CollectionSamples("Recomendados", rositaGracioso, "https://m.media-amazon.com/images/I/51a0PiL88RL._SY445_SX342_.jpg","Recomendados"),
            ...
            CollectionSamples("Blog", GreenAppOpacity, "https://previews.123rf.com/images/olegdudko/olegdudko1712/olegdudko171201274/90967469-libros-y-computadora-port%C3%A1til.jpg","Blog"),
            CollectionSamples("Premiados", GreenAppOpacity, "https://phantom-expansion.unidadeditorial.es/ca3e81ca6c16010e5d1fc2367d9a004a/crop/0x22/552x756/resize/640/assets/multimedia/imagenes/2022/02/28/16460499793522.jpg","Premiados"),
            CollectionSamples("eBooks", rositaGracioso, "https://cdn.computerhoy.com/sites/navi.axelspringer.es/public/media/image/2018/11/ereader.jpg?tf=3840x","eBooks"),
